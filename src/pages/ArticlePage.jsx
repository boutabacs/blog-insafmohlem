  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      <main className="w-full py-10 md:py-20">
        ...
        <div className="max-w-[1100px] mx-auto px-4 mb-10 md:mb-16 flex flex-col items-start text-left">
          <div className="inline-block mb-6 md:mb-8">
            <span className="text-[10px] md:text-[11px] font-black tracking-[0.3em] uppercase text-black border-b-2 border-black pb-1">
              {post.category}
            </span>
          </div>
          <h1 className="text-4xl sm:text-5xl md:text-[80px] font-bold mb-8 md:mb-10 leading-[1.1] md:leading-[1] max-w-[1000px] text-black">
            {post.title}
          </h1>
          <div className="flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-6 text-[10px] md:text-[11px] font-bold tracking-widest uppercase text-black">
            <div className="w-12 h-12 md:w-14 md:h-14 bg-gray-100 rounded-full flex items-center justify-center flex-shrink-0">
              <svg className="w-8 h-8 md:w-10 md:h-10 text-gray-300" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="flex flex-col md:flex-row gap-10 md:gap-8 relative">
            ...
            <aside className="md:sticky md:top-24 h-fit border-b md:border-none pb-8 md:pb-0 border-gray-100">
              <div className="flex flex-row md:flex-col gap-6 text-gray-400 items-center justify-center md:justify-start md:w-10">
                <a href="#" className="hover:text-black transition-colors text-xl"><FaFacebookF /></a>
                <a href="#" className="hover:text-black transition-colors text-xl"><FaTwitter /></a>
                <a href="#" className="hover:text-black transition-colors text-xl"><FaPinterestP /></a>
                <a href="#" className="hover:text-black transition-colors text-xl"><FaLinkedinIn /></a>
              </div>
            </aside>
