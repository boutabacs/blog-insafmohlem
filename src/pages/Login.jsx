      ...
      <main className="flex-grow flex items-center justify-center py-20 px-4">
        <div className="w-full max-w-[450px] bg-white p-8 md:p-12 border border-gray-100 shadow-sm">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-500 text-sm tracking-wide">Enter your details to access your account</p>
          </div>
          ...
          <form className="space-y-6">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                ...
                <a href="#" className="text-[10px] font-bold text-gray-400 hover:text-black transition-colors uppercase tracking-tighter">
                  Forgot Password?
                </a>
              </div>
              <input
